...
const ar: typeof en = {
  ...
  register: { title: "أنشئ شركتك", subtitle: "سجّل وأكّد بريدك.", company: "اسم الشركة", name: "اسمك", phone: "رقم الجوال", email: "البريد", password: "كلمة المرور", createAccount: "إنشاء حساب", verifyTitle: "أكّد بريدك", verifySubtitle: "أدخل الرمز المكوّن من 6 أرقام المُرسل إلى {email}.", verify: "تأكيد", resend: "إعادة إرسال الرمز", resendIn: "إعادة إرسال الرمز خلال {s} ثانية", codeSent: "تم إرسال الرمز", codeResent: "تم إرسال رمز جديد", failed: "فشل التسجيل", verifyFailed: "فشل التأكيد", haveAccount: "عندك حساب؟", signIn: "تسجيل الدخول", verifiedNeedsCode: "تم التأكيد! سجّل الدخول أو أدخل كود التفعيل." },
