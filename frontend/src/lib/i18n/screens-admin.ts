...
const en = {
  ...
  reseller: {
    ...
    copied: "Copied", copy: "Copy", daysN: "{n} days", validHint: "valid for 1 hour", newCode: "New code", paymentRef: "Payment reference:",
  ...
  codes: {
    ...
    colRef: "Reference",
    method: "Payment method", method_bank: "Bank transfer", method_cash: "Cash", methodOff: "Off — enable it in settings", methodNoneHint: "Enable a payment method in Platform settings to record it here.",
    payTitle: "How to pay", paySubtitle: "Pay using one of the methods below, then send us your transfer details to receive your activation code.",
    payBank: "Bank transfer", payBankHolder: "Account holder", payBankName: "Bank", payBankIban: "IBAN", payBankBic: "BIC", payBankAmount: "Amount",
    payCash: "Cash / phone", payContactWhatsapp: "Contact on WhatsApp",
    yourReference: "Your payment reference", referenceHint: "Include this reference in your bank transfer, then confirm below.", copy: "Copy",
    scanToPay: "Open your banking app and scan (GiroCode) — the transfer is prefilled", scanToPayHint: "A normal phone camera only shows text; scan it inside your bank’s app.",
    confirmPayment: "I’ve paid — confirm", confirmPaymentHint: "Notifies us to verify your transfer by the reference and send your activation code.",
    claimPendingLabel: "Payment confirmation pending — we’ll email you once verified.",
    claimSent: "Payment confirmation sent", claimFailed: "Couldn’t send confirmation",
  },
  claims: {
    title: "Payment requests", plan: "Plan", selectPlan: "— Select plan —", method: "Method",
    accept: "Accept", acceptCta: "Accept & send code", reject: "Reject", rejectCta: "Reject & notify",
    reason: "Reason", reasonPlaceholder: "e.g. amount doesn’t match / transfer not found", cancel: "Cancel",
    accepted: "Payment accepted — code sent", rejected: "Payment rejected — company notified", resolveFailed: "Could not resolve",
    filter_pending: "Pending", filter_confirmed: "Accepted", filter_rejected: "Rejected", filter_all: "All",
    st_pending: "Pending", st_confirmed: "Accepted", st_rejected: "Rejected",
    empty: "No requests here.", resolvedBy: "by",
  },
  subscriptions: {
  ...
  emailTemplates: {
    tool_bold: "Bold", tool_italic: "Italic", tool_underline: "Underline", tool_strike: "Strikethrough", tool_h1: "Heading 1", tool_h2: "Heading 2", tool_ul: "Bulleted list", tool_ol: "Numbered list", tool_alignLeft: "Align left", tool_alignCenter: "Align center", tool_alignRight: "Align right", tool_link: "Link", tool_undo: "Undo", tool_redo: "Redo", linkPrompt: "Link URL (https://…)",
  ...
  invoiceTemplate: {
    ...
    secLabels: "Labels / Headings", labelsHint: "Override any heading — leave empty to keep the German default.",
    secFooterBlocks: "Footer blocks", footerBlocksHint: "Editable footer columns. Each has a heading and label/value lines.",
    addBlock: "Add block", removeBlock: "Remove block", addLine: "Add line", removeLine: "Remove line",
    blockHeading: "Column heading", lineLabel: "Label (optional)", lineValue: "Value", moveUp: "Move up", moveDown: "Move down",
    labelKeys: {
      bill_to: "Bill to", invoice_date: "Invoice date", period: "Service period", activation_code: "Activation code",
      customer_no: "Customer no.", invoice_no: "Invoice no.", description: "Description", qty: "Qty", unit_price: "Unit price",
      amount: "Amount", subtotal: "Subtotal", total: "Total", paid: "Paid", paid_at: "Paid at", payment_method: "Payment method",
      sold_by: "Sold by", contact: "Contact", tax_bank: "Tax & bank",
    },
  },
  adminDashboard: {
  ...
  settings: {
    keepBlankPlaceholder: "••••••••  (leave blank to keep)",
    tab_email: "Email", tab_support: "Support", tab_payment: "Payments", tab_mobile: "Mobile app",
    ...
    proxyUrl: "Proxy URL",
    payment: "Subscription payment methods", paymentHint: "Enabled methods are shown to companies when they need to pay. Turn each on and off independently.",
    payBank: "Bank transfer", payBankHolder: "Account holder", payBankName: "Bank name", payBankIban: "IBAN", payBankBic: "BIC", payBankAmount: "Amount (€) — prefilled in the QR", payBankNote: "Note",
    payCash: "Cash / phone contact", payCashWhatsapp: "WhatsApp / phone", payCashNote: "Note",
...
const de: typeof en = {
  ...
  reseller: {
    ...
    copied: "Kopiert", copy: "Kopieren", daysN: "{n} Tage", validHint: "1 Stunde gültig", newCode: "Neuer Code", paymentRef: "Zahlungsreferenz:",
  ...
  codes: {
    ...
    colRef: "Referenz",
    method: "Zahlungsart", method_bank: "Banküberweisung", method_cash: "Bar", methodOff: "Aus — in den Einstellungen aktivieren", methodNoneHint: "Aktiviere eine Zahlungsart in den Plattform-Einstellungen, um sie hier zu erfassen.",
    payTitle: "So bezahlst du", paySubtitle: "Zahle über eine der folgenden Methoden und sende uns anschließend deine Überweisungsdetails, um deinen Aktivierungscode zu erhalten.",
    payBank: "Banküberweisung", payBankHolder: "Kontoinhaber", payBankName: "Bank", payBankIban: "IBAN", payBankBic: "BIC", payBankAmount: "Betrag",
    payCash: "Bar / Telefon", payContactWhatsapp: "Über WhatsApp kontaktieren",
    yourReference: "Ihre Zahlungsreferenz", referenceHint: "Geben Sie diese Referenz bei Ihrer Überweisung an und bestätigen Sie unten.", copy: "Kopieren",
    scanToPay: "In Ihrer Banking-App scannen (GiroCode) — Überweisung wird ausgefüllt", scanToPayHint: "Die normale Handykamera zeigt nur Text; scannen Sie ihn in der App Ihrer Bank.",
    confirmPayment: "Ich habe bezahlt — bestätigen", confirmPaymentHint: "Wir prüfen Ihre Überweisung anhand der Referenz und senden Ihren Aktivierungscode.",
    claimPendingLabel: "Zahlungsbestätigung ausstehend — wir melden uns per E-Mail.",
    claimSent: "Zahlungsbestätigung gesendet", claimFailed: "Bestätigung konnte nicht gesendet werden",
  },
  claims: {
    title: "Zahlungsanfragen", plan: "Paket", selectPlan: "— Paket wählen —", method: "Zahlungsart",
    accept: "Annehmen", acceptCta: "Annehmen & Code senden", reject: "Ablehnen", rejectCta: "Ablehnen & benachrichtigen",
    reason: "Grund", reasonPlaceholder: "z. B. Betrag stimmt nicht / Überweisung nicht gefunden", cancel: "Abbrechen",
    accepted: "Zahlung angenommen — Code gesendet", rejected: "Zahlung abgelehnt — Firma benachrichtigt", resolveFailed: "Konnte nicht bearbeitet werden",
    filter_pending: "Offen", filter_confirmed: "Angenommen", filter_rejected: "Abgelehnt", filter_all: "Alle",
    st_pending: "Offen", st_confirmed: "Angenommen", st_rejected: "Abgelehnt",
    empty: "Keine Anfragen.", resolvedBy: "von",
  },
  subscriptions: {
  ...
  emailTemplates: {
    tool_bold: "Fett", tool_italic: "Kursiv", tool_underline: "Unterstrichen", tool_strike: "Durchgestrichen", tool_h1: "Überschrift 1", tool_h2: "Überschrift 2", tool_ul: "Aufzählung", tool_ol: "Nummerierte Liste", tool_alignLeft: "Linksbündig", tool_alignCenter: "Zentriert", tool_alignRight: "Rechtsbündig", tool_link: "Link", tool_undo: "Rückgängig", tool_redo: "Wiederholen", linkPrompt: "Link-URL (https://…)",
  ...
  invoiceTemplate: {
    ...
    secLabels: "Beschriftungen / Überschriften", labelsHint: "Überschreibe jede Überschrift — leer lassen für den deutschen Standard.",
    secFooterBlocks: "Fußzeilen-Blöcke", footerBlocksHint: "Editierbare Fußzeilen-Spalten. Jede hat eine Überschrift und Label/Wert-Zeilen.",
    addBlock: "Block hinzufügen", removeBlock: "Block entfernen", addLine: "Zeile hinzufügen", removeLine: "Zeile entfernen",
    blockHeading: "Spaltenüberschrift", lineLabel: "Label (optional)", lineValue: "Wert", moveUp: "Nach oben", moveDown: "Nach unten",
    labelKeys: {
      bill_to: "Rechnung an", invoice_date: "Rechnungsdatum", period: "Leistungszeitraum", activation_code: "Aktivierungscode",
      customer_no: "Kunden-Nr.", invoice_no: "Rechnungs-Nr.", description: "Beschreibung", qty: "Menge", unit_price: "Einzelpreis",
      amount: "Betrag", subtotal: "Zwischensumme", total: "Gesamtbetrag", paid: "Bezahlt", paid_at: "Bezahlt am", payment_method: "Zahlungsart",
      sold_by: "Vermittelt von", contact: "Kontakt", tax_bank: "Steuer & Bank",
    },
  },
  adminDashboard: {
  ...
  settings: {
    keepBlankPlaceholder: "••••••••  (leer lassen, um beizubehalten)",
    tab_email: "E-Mail", tab_support: "Support", tab_payment: "Zahlungen", tab_mobile: "Mobile App",
    ...
    proxyUrl: "Proxy-URL",
    payment: "Zahlungsarten für Abonnements", paymentHint: "Aktivierte Zahlungsarten werden Firmen bei fälliger Zahlung angezeigt. Jede lässt sich einzeln ein- und ausschalten.",
    payBank: "Banküberweisung", payBankHolder: "Kontoinhaber", payBankName: "Bankname", payBankIban: "IBAN", payBankBic: "BIC", payBankAmount: "Betrag (€) — im QR vorausgefüllt", payBankNote: "Hinweis",
    payCash: "Bar / Telefonkontakt", payCashWhatsapp: "WhatsApp / Telefon", payCashNote: "Hinweis",
...
const ar: typeof en = {
  ...
  reseller: {
    ...
    copied: "تم النسخ", copy: "نسخ", daysN: "{n} يوم", validHint: "صالح ساعة", newCode: "كود جديد", paymentRef: "مرجع الدفع:",
  ...
  codes: {
    ...
    colRef: "المرجع",
    method: "طريقة الدفع", method_bank: "تحويل بنكي", method_cash: "كاش", methodOff: "مطفأة — فعّلها من الإعدادات", methodNoneHint: "فعّل طريقة دفع من إعدادات المنصة حتى تقدر تسجّلها هون.",
    payTitle: "طريقة الدفع", paySubtitle: "ادفع عبر إحدى الطرق التالية، ثم أرسل لنا تفاصيل الحوالة لتحصل على كود التفعيل.",
    payBank: "تحويل بنكي", payBankHolder: "صاحب الحساب", payBankName: "البنك", payBankIban: "IBAN", payBankBic: "BIC", payBankAmount: "المبلغ",
    payCash: "كاش / هاتف", payContactWhatsapp: "تواصل عبر واتساب",
    yourReference: "رقمك المرجعي للدفع", referenceHint: "اكتب هذا الرقم المرجعي في الحوالة البنكية، وبعدها أكّد بالأسفل.", copy: "نسخ",
    scanToPay: "افتح تطبيق بنكك وامسح الكود (GiroCode) — الحوالة بتتعبّى تلقائياً", scanToPayHint: "كاميرا الموبايل العادية بتطلّع نص فقط؛ امسحه من داخل تطبيق البنك.",
    confirmPayment: "دفعت — أكّد", confirmPaymentHint: "بننبّهكم نتأكد من حوالتك بالرقم المرجعي ونبعتلك كود التفعيل.",
    claimPendingLabel: "تأكيد الدفع قيد المراجعة — رح نبعتلك إيميل بعد التحقق.",
    claimSent: "تم إرسال تأكيد الدفع", claimFailed: "تعذّر إرسال التأكيد",
  },
  claims: {
    title: "طلبات الدفع", plan: "الباقة", selectPlan: "— اختر باقة —", method: "طريقة الدفع",
    accept: "قبول", acceptCta: "قبول وإرسال الكود", reject: "رفض", rejectCta: "رفض وإبلاغ",
    reason: "السبب", reasonPlaceholder: "مثلاً المبلغ غير مطابق / ما لقينا الحوالة", cancel: "إلغاء",
    accepted: "تم قبول الدفع — انبعت الكود", rejected: "تم رفض الدفع — انبلغت الشركة", resolveFailed: "تعذّرت المعالجة",
    filter_pending: "معلّقة", filter_confirmed: "مقبولة", filter_rejected: "مرفوضة", filter_all: "الكل",
    st_pending: "معلّقة", st_confirmed: "مقبولة", st_rejected: "مرفوضة",
    empty: "لا توجد طلبات.", resolvedBy: "بواسطة",
  },
  subscriptions: {
  ...
  emailTemplates: {
    tool_bold: "عريض", tool_italic: "مائل", tool_underline: "تسطير", tool_strike: "يتوسطه خط", tool_h1: "عنوان 1", tool_h2: "عنوان 2", tool_ul: "قائمة نقطية", tool_ol: "قائمة مرقّمة", tool_alignLeft: "محاذاة لليسار", tool_alignCenter: "توسيط", tool_alignRight: "محاذاة لليمين", tool_link: "رابط", tool_undo: "تراجع", tool_redo: "إعادة", linkPrompt: "رابط URL (https://…)",
  ...
  invoiceTemplate: {
    ...
    secLabels: "التسميات / العناوين", labelsHint: "تجاوز أي عنوان — اتركه فاضي للإبقاء على الافتراضي الألماني.",
    secFooterBlocks: "بلوكات التذييل", footerBlocksHint: "أعمدة تذييل قابلة للتعديل. لكل عمود عنوان وأسطر تسمية/قيمة.",
    addBlock: "إضافة بلوك", removeBlock: "حذف البلوك", addLine: "إضافة سطر", removeLine: "حذف السطر",
    blockHeading: "عنوان العمود", lineLabel: "التسمية (اختياري)", lineValue: "القيمة", moveUp: "تحريك لأعلى", moveDown: "تحريك لأسفل",
    labelKeys: {
      bill_to: "فاتورة إلى", invoice_date: "تاريخ الفاتورة", period: "فترة الخدمة", activation_code: "رمز التفعيل",
      customer_no: "رقم العميل", invoice_no: "رقم الفاتورة", description: "الوصف", qty: "الكمية", unit_price: "سعر الوحدة",
      amount: "المبلغ", subtotal: "المجموع الفرعي", total: "الإجمالي", paid: "مدفوع", paid_at: "تاريخ الدفع", payment_method: "طريقة الدفع",
      sold_by: "بواسطة", contact: "التواصل", tax_bank: "الضريبة والبنك",
    },
  },
  adminDashboard: {
  ...
  settings: {
    keepBlankPlaceholder: "••••••••  (اتركه فارغاً للإبقاء عليه)",
    tab_email: "البريد", tab_support: "الدعم", tab_payment: "المدفوعات", tab_mobile: "تطبيق الموبايل",
    ...
    payment: "طرق دفع الاشتراك", paymentHint: "الطرق المفعّلة تظهر للشركات عند استحقاق الدفع. كل طريقة تُفعَّل وتُطفَأ لحالها.",
    payBank: "تحويل بنكي", payBankHolder: "اسم صاحب الحساب", payBankName: "اسم البنك", payBankIban: "IBAN", payBankBic: "BIC", payBankAmount: "المبلغ (€) — يُعبّأ تلقائياً في الـQR", payBankNote: "ملاحظة",
    payCash: "كاش / تواصل هاتفي", payCashWhatsapp: "واتساب / هاتف", payCashNote: "ملاحظة",
