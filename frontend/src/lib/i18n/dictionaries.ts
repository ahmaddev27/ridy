...
const en = {
  ...
  nav: {
    ...
    companies: "Companies", banned: "Banned", proxies: "Proxies", collectors: "Collectors", subscriptions: "Subscriptions", users: "Users", generateCode: "Generate code",
...
const de: typeof en = {
  ...
  nav: {
    ...
    auditLog: "Audit-Log",
    designSystem: "Design-System",
    companies: "Firmen", banned: "Gesperrt", proxies: "Proxys", collectors: "Inkasso", subscriptions: "Abonnements", users: "Benutzer", generateCode: "Code erstellen",
    adminDashboard: "Dashboard",
...
const ar: typeof en = {
  ...
  nav: {
    ...
    companies: "الشركات", banned: "المحظورة", proxies: "البروكسيات", collectors: "المحصّلون", subscriptions: "الاشتراكات", users: "المستخدمون", generateCode: "توليد كود",
