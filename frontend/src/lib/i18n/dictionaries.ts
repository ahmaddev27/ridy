...
const en = {
  ...
  suspended: { reason_disabled: "Your company account is disabled.", reason_banned: "Your account is locked after too many wrong activation codes.", reason_expired: "Your subscription has expired.", contactHint: "Please contact support to restore access.", whatsapp: "Contact on WhatsApp", email: "Email support", activateTitle: "Have an activation code?", activateHint: "Enter the 6-digit code from support to renew.", activateCta: "Activate", activated: "Activated — signing you in…", activateFailed: "Activation failed", haveCode: "Have an activation code?", backToLogin: "Back to sign in" },
  login: {
    title: "Sign in",
