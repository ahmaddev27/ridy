...
const en = {
  ...
  nav: {
    ...
    companies: "Companies", banned: "Banned",
  ...
  errors: { otp_incorrect: "Incorrect code.", otp_expired: "The code has expired — please resend.", otp_too_many: "Too many attempts — please resend a new code.", otp_none: "No pending request for this email.", generic: "Something went wrong. Please try again." },
  suspended: { reason_disabled: "Your company account is disabled.", reason_banned: "Your account is locked after too many wrong activation codes.", reason_expired: "Your subscription has expired.", contactHint: "Please contact support to restore access.", whatsapp: "Contact on WhatsApp", email: "Email support", activateTitle: "Have an activation code?", activateHint: "Enter the 6-digit code from support to renew.", activateCta: "Activate", activated: "Activated — signing you in…", activateFailed: "Activation failed" },
  login: {
    title: "Sign in",
...
const de: typeof en = {
  ...
  nav: {
    ...
    auditLog: "Audit-Log",
    designSystem: "Design-System",
    companies: "Firmen", banned: "Gesperrt",
    adminDashboard: "Dashboard",
  ...
  errors: { otp_incorrect: "Falscher Code.", otp_expired: "Der Code ist abgelaufen — bitte erneut senden.", otp_too_many: "Zu viele Versuche — bitte neuen Code senden.", otp_none: "Keine offene Anfrage für diese E-Mail.", generic: "Etwas ist schiefgelaufen. Bitte erneut versuchen." },
  suspended: { reason_disabled: "Dein Firmenkonto ist deaktiviert.", reason_banned: "Dein Konto ist nach zu vielen falschen Aktivierungscodes gesperrt.", reason_expired: "Dein Abonnement ist abgelaufen.", contactHint: "Bitte kontaktiere den Support, um den Zugang wiederherzustellen.", whatsapp: "Über WhatsApp kontaktieren", email: "Support per E-Mail", activateTitle: "Hast du einen Aktivierungscode?", activateHint: "Gib den 6-stelligen Code vom Support ein, um zu verlängern.", activateCta: "Aktivieren", activated: "Aktiviert — du wirst angemeldet…", activateFailed: "Aktivierung fehlgeschlagen" },
  login: {
    title: "Anmelden",
...
const ar: typeof en = {
  ...
  nav: {
    ...
    companies: "الشركات", banned: "المحظورة",
  ...
  errors: { otp_incorrect: "الرمز غير صحيح.", otp_expired: "انتهت صلاحية الرمز — أعد الإرسال.", otp_too_many: "محاولات كثيرة — أرسل رمزاً جديداً.", otp_none: "لا يوجد طلب لهذا البريد.", generic: "حدث خطأ ما. حاول مرة أخرى." },
  suspended: { reason_disabled: "حساب شركتك معطّل.", reason_banned: "تم قفل حسابك بعد إدخال رمز التفعيل خطأ عدة مرات.", reason_expired: "انتهى اشتراكك.", contactHint: "تواصل مع الدعم لاستعادة الوصول.", whatsapp: "تواصل عبر واتساب", email: "راسل الدعم بالإيميل", activateTitle: "عندك رمز تفعيل؟", activateHint: "أدخل الرمز المكوّن من 6 أرقام من الدعم للتجديد.", activateCta: "تفعيل", activated: "تم التفعيل — يتم تسجيل دخولك…", activateFailed: "فشل التفعيل" },
  login: {
    title: "تسجيل الدخول",
