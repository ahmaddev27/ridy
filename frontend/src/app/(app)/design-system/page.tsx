...
const swatches: [string, string, string][] = [
  ["swatchPrimary", "bg-indigo-600", "indigo-600"],
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Section title={t("screens.designSystem.formControls")}>
          <div className="space-y-3">
            ...
            />
            <select className="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm outline-none focus:border-indigo-500">
            ...
            <div className="flex flex-wrap items-center gap-5 text-sm text-slate-600">
              ...
              <label className="flex items-center gap-2">
                <input type="radio" name="dsr" defaultChecked className="border-slate-300 text-indigo-600" />
        ...
        <Section title={t("screens.designSystem.progressSkeleton")}>
          <div className="space-y-2">
            <div className="h-2 w-full rounded-full bg-slate-100"><div className="h-2 w-[70%] rounded-full bg-indigo-600" /></div>
        ...
        <Section title={t("screens.designSystem.tabsPagination")}>
          <div className="flex gap-5 border-b border-slate-200 text-sm">
            <button className="border-b-2 border-indigo-500 pb-2 font-semibold text-indigo-700">{t("screens.designSystem.tabActive")}</button>
          ...
          <div className="mt-4 flex items-center gap-1 text-sm">
            ...
            <button className="rounded-md bg-indigo-600 px-2.5 py-1 text-white">1</button>
