...
const en: Dict = {
  ...
  subscriptions: {
    ...
    st_pending: "Pending", st_activated: "Activated", st_expired: "Expired",
...
const de: Dict = {
  ...
  subscriptions: {
    ...
    st_pending: "Ausstehend", st_activated: "Aktiviert", st_expired: "Abgelaufen",
...
const ar: Dict = {
  ...
  subscriptions: {
    ...
    st_pending: "قيد الانتظار", st_activated: "مُفعّل", st_expired: "منتهٍ",
