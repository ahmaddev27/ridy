...
const en = {
  ...
  authPanel: { statDrivers: "Active drivers", statUptime: "Uptime", statSupport: "Support", testimonialRole: "Fleet Manager · Move Now" },
...
const de: typeof en = {
  ...
  authPanel: { statDrivers: "Aktive Fahrer", statUptime: "Verfügbarkeit", statSupport: "Support", testimonialRole: "Flottenmanagerin · Move Now" },
...
const ar: typeof en = {
  ...
  authPanel: { statDrivers: "سائق نشط", statUptime: "وقت التشغيل", statSupport: "دعم فني", testimonialRole: "مديرة أسطول · Move Now" },
