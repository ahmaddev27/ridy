...
const en = {
  ...
  onboarding: {
    ...
    connectBody: "Install the Reidey extension and sign in once. It captures your dispatch stream so we see every incoming offer — no passwords stored.",
...
const de: typeof en = {
  ...
  onboarding: {
    ...
    connectBody: "Installiere die Reidey-Erweiterung und melde dich einmal an. Sie erfasst deinen Dispatch-Stream, damit wir jedes Angebot sehen — keine Passwörter gespeichert.",
...
const ar: typeof en = {
  ...
  onboarding: {
    ...
    connectBody: "ثبّت إضافة Reidey وسجّل الدخول مرّة واحدة. تلتقط بثّ التوزيع عندك لنرى كل عرض وارد — بدون تخزين كلمات مرور.",
