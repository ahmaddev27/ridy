...
const en = {
  ...
  reseller: {
    ...
    copied: "Copied", copy: "Copy", daysN: "{n} days", validHint: "valid for 10 minutes", newCode: "New code", paymentRef: "Payment reference:",
...
const de: typeof en = {
  ...
  reseller: {
    ...
    copied: "Kopiert", copy: "Kopieren", daysN: "{n} Tage", validHint: "10 Minuten gültig", newCode: "Neuer Code", paymentRef: "Zahlungsreferenz:",
...
const ar: typeof en = {
  ...
  reseller: {
    ...
    copied: "تم النسخ", copy: "نسخ", daysN: "{n} يوم", validHint: "صالح 10 دقائق", newCode: "كود جديد", paymentRef: "مرجع الدفع:",
