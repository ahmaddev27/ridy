...
const en = {
  ...
  codes: {
    ...
    payBank: "Bank transfer", payBankHolder: "Account holder", payBankName: "Bank", payBankIban: "IBAN", payBankBic: "BIC",
    ...
    scanToPay: "Scan to pay from your banking app",
  ...
  settings: {
    ...
    payBank: "Bank transfer", payBankHolder: "Account holder", payBankName: "Bank name", payBankIban: "IBAN", payBankBic: "BIC", payBankNote: "Note",
...
const de: typeof en = {
  ...
  codes: {
    ...
    payBank: "Banküberweisung", payBankHolder: "Kontoinhaber", payBankName: "Bank", payBankIban: "IBAN", payBankBic: "BIC",
    ...
    scanToPay: "Zum Bezahlen mit Ihrer Banking-App scannen",
  ...
  settings: {
    ...
    payBank: "Banküberweisung", payBankHolder: "Kontoinhaber", payBankName: "Bankname", payBankIban: "IBAN", payBankBic: "BIC", payBankNote: "Hinweis",
...
const ar: typeof en = {
  ...
  codes: {
    ...
    payBank: "تحويل بنكي", payBankHolder: "صاحب الحساب", payBankName: "البنك", payBankIban: "IBAN", payBankBic: "BIC",
    ...
    scanToPay: "امسح الكود للدفع من تطبيق البنك",
  ...
  settings: {
    ...
    payBank: "تحويل بنكي", payBankHolder: "اسم صاحب الحساب", payBankName: "اسم البنك", payBankIban: "IBAN", payBankBic: "BIC", payBankNote: "ملاحظة",
