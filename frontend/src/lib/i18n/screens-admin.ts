...
const en = {
  ...
  codes: {
    ...
    colRef: "Reference",
    method: "Payment method", method_bank: "Bank transfer", method_cash: "Cash",
...
const de: typeof en = {
  ...
  codes: {
    ...
    colRef: "Referenz",
    method: "Zahlungsart", method_bank: "Banküberweisung", method_cash: "Bar",
...
const ar: typeof en = {
  ...
  codes: {
    ...
    colRef: "المرجع",
    method: "طريقة الدفع", method_bank: "تحويل بنكي", method_cash: "كاش",
