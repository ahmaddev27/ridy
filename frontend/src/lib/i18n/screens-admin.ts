...
const en: Dict = {
  ...
  systemHealth: {
    colCompany: "Company", colSubscription: "Subscription", colSession: "Uber session", colDaemon: "Daemon", colProxy: "Proxy", clearNetwork: "Clear Network logs", clearNetworkConfirm: "Delete ALL captured Network logs for every company? This cannot be undone.", clearNetworkDone: "Cleared {n} entries", clearNetworkFailed: "Could not clear",
...
const de: Dict = {
  ...
  systemHealth: {
    colCompany: "Firma", colSubscription: "Abonnement", colSession: "Uber-Sitzung", colDaemon: "Daemon", colProxy: "Proxy", clearNetwork: "Netzwerk-Logs leeren", clearNetworkConfirm: "ALLE erfassten Netzwerk-Logs aller Firmen löschen? Kann nicht rückgängig gemacht werden.", clearNetworkDone: "{n} Einträge gelöscht", clearNetworkFailed: "Konnte nicht leeren",
...
const ar: Dict = {
  ...
  systemHealth: {
    colCompany: "الشركة", colSubscription: "الاشتراك", colSession: "جلسة أوبر", colDaemon: "الخدمة", colProxy: "البروكسي", clearNetwork: "تصفير سجلات الشبكة", clearNetworkConfirm: "حذف كل سجلات الشبكة الملتقطة لكل الشركات؟ لا يمكن التراجع.", clearNetworkDone: "تم حذف {n} عنصر", clearNetworkFailed: "تعذّر التصفير",
