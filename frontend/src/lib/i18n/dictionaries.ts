...
const en = {
  ...
  nav: {
    ...
    companies: "Companies", banned: "Banned", proxies: "Proxies", collectors: "Collectors", subscriptions: "Reports",
  ...
  pages: {
    ...
    subscriptions: { title: "Reports", subtitle: "Subscription revenue, expiring plans and invoices." },
...
const de: typeof en = {
  ...
  nav: {
    ...
    auditLog: "Audit-Log",
    designSystem: "Design-System",
    companies: "Firmen", banned: "Gesperrt", proxies: "Proxys", collectors: "Inkasso", subscriptions: "Berichte",
    adminDashboard: "Dashboard",
  ...
  pages: {
    ...
    subscriptions: { title: "Berichte", subtitle: "Abo-Umsatz, auslaufende Pläne und Rechnungen." },
...
const ar: typeof en = {
  ...
  nav: {
    ...
    companies: "الشركات", banned: "المحظورة", proxies: "البروكسيات", collectors: "المحصّلون", subscriptions: "التقارير",
  ...
  pages: {
    ...
    subscriptions: { title: "التقارير", subtitle: "إيرادات الاشتراكات، الاشتراكات القاربة على الانتهاء، والفواتير." },
