...
const en = {
  ...
  authPanel: { statDrivers: "Active drivers", statUptime: "Uptime", statSupport: "Support" },
...
const de: typeof en = {
  ...
  authPanel: { statDrivers: "Aktive Fahrer", statUptime: "Verfügbarkeit", statSupport: "Support" },
...
const ar: typeof en = {
  ...
  authPanel: { statDrivers: "سائق نشط", statUptime: "وقت التشغيل", statSupport: "دعم فني" },
