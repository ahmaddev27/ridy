...
const en = {
  ...
  nav: {
    ...
    companies: "Companies", banned: "Banned", proxies: "Proxies", collectors: "Collectors", subscriptions: "Subscriptions", users: "Users", orphanDrivers: "Free-agent drivers", generateCode: "Generate code", codes: "Codes",
...
const de: typeof en = {
  ...
  nav: {
    ...
    auditLog: "Audit-Log",
    designSystem: "Design-System",
    companies: "Firmen", banned: "Gesperrt", proxies: "Proxys", collectors: "Inkasso", subscriptions: "Abonnements", users: "Benutzer", orphanDrivers: "Freie Fahrer", generateCode: "Code erstellen", codes: "Codes",
...
const ar: typeof en = {
  ...
  nav: {
    ...
    companies: "الشركات", banned: "المحظورة", proxies: "البروكسيات", collectors: "المحصّلون", subscriptions: "الاشتراكات", users: "المستخدمون", orphanDrivers: "سائقون بلا شركة", generateCode: "توليد كود", codes: "الأكواد",
