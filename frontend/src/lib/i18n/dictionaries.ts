...
const en = {
  ...
  nav: {
    ...
    companies: "Companies", banned: "Banned", proxies: "Proxies", collectors: "Collectors",
...
const de: typeof en = {
  ...
  nav: {
    ...
    auditLog: "Audit-Log",
    designSystem: "Design-System",
    companies: "Firmen", banned: "Gesperrt", proxies: "Proxys", collectors: "Inkasso",
    adminDashboard: "Dashboard",
...
const ar: typeof en = {
  ...
  nav: {
    ...
    companies: "الشركات", banned: "المحظورة", proxies: "البروكسيات", collectors: "المحصّلون",
