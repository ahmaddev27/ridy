...
const de: typeof en = {
  ...
  forgot: { title: "Passwort zurücksetzen", subtitle: "Gib deine E-Mail ein — wir senden einen 6-stelligen Code.", email: "E-Mail", sendCode: "Code senden", resetTitle: "Code eingeben", resetSubtitle: "Wir haben einen 6-stelligen Code an {email} gesendet.", newPassword: "Neues Passwort", resetCta: "Passwort zurücksetzen", resend: "Code erneut senden", codeSent: "Code gesendet", codeResent: "Neuer Code gesendet", resetDone: "Passwort zurückgesetzt — bitte anmelden", failed: "Code konnte nicht gesendet werden", resetFailed: "Zurücksetzen fehlgeschlagen", backToLogin: "Zurück zur Anmeldung" },
  login: {
    title: "Anmelden",
...
const ar: typeof en = {
  ...
  forgot: { title: "استعادة كلمة المرور", subtitle: "أدخل بريدك وسنرسل لك رمزاً من 6 أرقام.", email: "البريد", sendCode: "إرسال الرمز", resetTitle: "أدخل الرمز", resetSubtitle: "أرسلنا رمزاً من 6 أرقام إلى {email}.", newPassword: "كلمة المرور الجديدة", resetCta: "تغيير كلمة المرور", resend: "إعادة إرسال الرمز", codeSent: "تم إرسال الرمز", codeResent: "تم إرسال رمز جديد", resetDone: "تم تغيير كلمة المرور — سجّل الدخول", failed: "تعذّر إرسال الرمز", resetFailed: "فشل التغيير", backToLogin: "العودة لتسجيل الدخول" },
  login: {
    title: "تسجيل الدخول",
