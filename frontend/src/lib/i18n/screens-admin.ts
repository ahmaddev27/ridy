...
const en: Dict = {
  ...
  settings: {
    email: "Email delivery", provider: "Provider", resendKey: "Resend API key", smtp: "Email (SMTP)", host: "Host", port: "Port", username: "Username",
...
const de: Dict = {
  ...
  settings: {
    email: "E-Mail-Versand", provider: "Anbieter", resendKey: "Resend-API-Schlüssel", smtp: "E-Mail (SMTP)", host: "Host", port: "Port", username: "Benutzername",
...
const ar: Dict = {
  ...
  settings: {
    email: "إرسال البريد", provider: "المزوّد", resendKey: "مفتاح Resend API", smtp: "البريد (SMTP)", host: "المضيف", port: "المنفذ", username: "اسم المستخدم",
