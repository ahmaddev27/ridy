...
const en: Dict = {
  ...
  companies: {
    ...
    deleteCompany: "Disable company", deleteConfirm: "Disable {name}? Its streams stop.",
    deletedToast: "Company disabled", deleteFailed: "Couldn’t disable",
    fieldName: "Name",
...
const de: Dict = {
  ...
  companies: {
    ...
    deleteCompany: "Firma deaktivieren", deleteConfirm: "{name} deaktivieren? Streams stoppen.",
    deletedToast: "Firma deaktiviert", deleteFailed: "Deaktivieren fehlgeschlagen",
    fieldName: "Name",
...
const ar: Dict = {
  ...
  companies: {
    ...
    deleteCompany: "تعطيل الشركة", deleteConfirm: "تعطيل {name}؟ سيتوقف بثّها.",
    deletedToast: "تم تعطيل الشركة", deleteFailed: "تعذّر التعطيل",
    fieldName: "الاسم",
